...
public class TelaInicial implements Tela {
    ...
    private void desenhaBotoes(){
      ...
      //  LeaderBoard.setPreferredSize(new Dimension(WIDTH/6,100));
        registro.setBackground(new Color(160, 165, 220));
        regras.setBackground(new Color(160, 165, 220));
      //  LeaderBoard.setBackground(new Color(160, 165, 220));
        ...
        regras.addActionListener(new BotaoRegras(this,new TelaRegras(this)));
         //LeaderBoard.addActionListener(new BotaoLeaderboard(this,new TelaLeadoerboard(this)));
        painelBotoes.add(login);    
        painelBotoes.add(registro);
        painelBotoes.add(regras);
  //        painelBotoes.add(LeaderBoard);
